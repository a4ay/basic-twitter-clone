...
class Tweet extends Component{
  ...
  render(){
    ...
    const {  name, avatar, timestamp, text, hasLiked,id, likes, replies, parent } = tweet
...
function mapStateToComponent({users,tweets,authUser},{id}){
...
export default withRouter(connect(mapStateToComponent)(Tweet))